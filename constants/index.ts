...
export const dryerServices = [
  ...
  export const chimneyServices = [
    ...
    {
      icon: ShieldCheck,
      title: "Safety & Optimal Draft",
      description:
      "Ensures proper airflow while reducing fire risks and improving overall chimney performance.",
    },
  ];

  // ===========!!!!!!?????????==============
  
  // this is my history as developer who developed this project, if u get chance to modify this project please connect me f.uwimpuhwe@alustudent.com
  ...
  //     description:
  //       "Started learning programming and web development, focusing on JavaScript and building small projects to understand core development concepts.",
  //   },
  //   {
  //     period: "2023",
  ...
  //     description:
  //       "Participated in Hack With Me Rwanda, Africa's talking and HackNoel hackathons, collaborating with students to build applications and improve teamwork and coding speed.",
  //   },
  //   {
  //     period: "2024",
  ...
  //     description:
  //       "Built multiple projects including React Native apps, Next.js systems, backend APIs, and real-world web applications.",
  //   },
  //   {
  //     period: "Now",
  //     title: "College Developer",
  //     role: "Full Stack & Mobile Developer",
  //     description:
  //       "Currently studying in college while continuing to build scalable web and mobile applications using modern technologies.",
  //   },
  // ];